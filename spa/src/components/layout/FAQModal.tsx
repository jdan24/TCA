        ...
        <div className="px-6 py-6 overflow-y-auto max-h-[calc(100vh-10rem)]">
          ...
          <Section title="Market Context">
            ...
            <Entry name="Cost vs Crossing the Spread chart" tag="per order">
              ...
              <Row label="Neutral band" value="±10% of the quoted spread. Without it the colour of an order that merely crossed is decided by rounding rather than execution — on a one-tick market a 1% change in the spread flips it between green and red. Orders inside the band count toward the headline figure, which reports orders at or better than crossing rather than strictly better than it." />
